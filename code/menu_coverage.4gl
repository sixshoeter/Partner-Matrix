...
#   display "<span style='font-size:18px;'><a href='../H/coverage_plan.html'>Coverage Plan </a>- </span> &nbsp / &nbsp"
   if( UnitModeYN() )then
      display "<span style='font-size:18px;'><a href='../H/coverage_planU.html'>Coverage Plan </a></span> &nbsp - &nbsp the coverage team for each Region/EU"
      if( CtlRec.cflg5 )then
         display "(see the map <a href='../H/coverage_map.jpg' target='_blank'>here</a>)"
      end if
      display "<p>"

      display "<span style='font-size:18px;'><a href='../H/coverage_eusU.html'>Coverage List (by BPR) </a></span> &nbsp - &nbsp listing of partners by IBM Channels BPR (Brand Rep) <p"
      display "<span style='font-size:18px;'><a href='../H/coverage_eus_tssU.html'>Coverage List (by TSS)</a></span> &nbsp - &nbsp listing of partners by IBM Channels TSS <p>"
   else
