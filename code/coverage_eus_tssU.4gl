...
display "<em><span style='font-size: 20px'>B U I L D * B R A N D * C O V E R A G E (by ", CtlRec.tss_ltext clipped, ")</span></em></div>"
display "<div dir='ltr' style='text-align: center'>"
...
if( NOT CtlRec.onlyshowaca )then
   ...
   let SQLStr=SQLStr clipped, " union "
end if
   let SQLStr=SQLStr clipped, " select unique '' ssr, '' ssr_link, s.r_name, s.r_link ",
      "from ", cov_tab clipped, " b, reps s ",
