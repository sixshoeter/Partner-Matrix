...
## August    22, 2016 - John M. Shoemaker, jshoe@us.ibm.com - add variable heading, #185
...
display "<em><span style='font-size: 20px'>G E O G R A P H Y * C O V E R A G E * P L A N</span></em></div>"
display "<div dir='ltr' style='text-align: center'>"
...
if( RepArr[1].ctp != 'Open' and RepArr[1].ctp != ' ')then
   display "<br><a href='", RepArr[1].ctp_link clipped, "' target='_blank'>", RepArr[1].ctp clipped, "</a>"
#else
