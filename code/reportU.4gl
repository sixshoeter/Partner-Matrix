...
let SQLStr = "select a.*, k.*, l.*, m.* from coverage_au a, skills_im k, skills_em l, skills_ba m where a.ceid='", CLRec.CEID clipped, "' and a.ceid = k.ceid and a.ceid = l.ceid and a.ceid = m.ceid "
...
report R1( rptCoverage, Kskill, Lskill, Mskill )
   define
      ...
      Kskill, Lskill, Mskill record like skills_im.*
...
need 9 lines
   ...
   print column 5, KRec.skill_01 using "#", " : BigInsights"
...
need 3 lines
   ...
   print column 5, KRec.skill_09 using "#", " : Bluemix"
   print column 5, KRec.skill_10 using "#", " : Cloud Databases"
...
print column 5, MRec.skill_16 using "#", " : Algorithmics", column 40, MRec.skill_25 using "#", " : Fin Risk Mgmt Bank and Fin Markets"
...
need 4 lines
print "*** CLOUD ***"
print column 5, LRec.skill_18 using "#", " : IBM Navigator"
print column 5, LRec.skill_19 using "#", " : Partner Cloud Solutions"
print column 5, LRec.skill_21 using "#", " : Curator"
