...
#echo 2
# generate std page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA SE $CEID 1 > $HOME/NA/SE/P/${CEID}.html
## change permissions
chmod 666 $HOME/NA/SE/P/${CEID}.html

# generate secret page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA SE $CEID 2 > $HOME/NA/SE/P/${CEID}-sec.html
## change permissions
chmod 666 $HOME/NA/SE/P/${CEID}-sec.html

# generate update page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA SE $CEID 5 #> $HOME/NA/SE/P/${CEID}-upd.html
#cat $HOME/NA/SE/P/${CEID}-upd.html
