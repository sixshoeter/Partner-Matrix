...
#echo 2
# generate std page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA ES $CEID 1 > $HOME/NA/ES/P/${CEID}.html
## change permissions
chmod 666 $HOME/NA/ES/P/${CEID}.html

# generate secret page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA ES $CEID 2 > $HOME/NA/ES/P/${CEID}-sec.html
## change permissions
chmod 666 $HOME/NA/ES/P/${CEID}.html

# generate update page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA ES $CEID 5 #> $HOME/NA/ES/P/${CEID}-upd.html
#cat $HOME/NA/ES/P/${CEID}-upd.html
