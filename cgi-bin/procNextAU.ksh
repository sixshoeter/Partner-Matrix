...
#echo 2
# generate std page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA AU $CEID 1 > $HOME/NA/AU/P/${CEID}.html
## change permissions
chmod 666 $HOME/NA/AU/P/${CEID}.html

# generate secret page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA AU $CEID 2 > $HOME/NA/AU/P/${CEID}-sec.html
## change permissions
chmod 666 $HOME/NA/AU/P/${CEID}-sec.html

# generate update page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA AU $CEID 5 #> $HOME/NA/AU/P/${CEID}-upd.html
#cat $HOME/NA/AU/P/${CEID}-upd.html
