...
echo ES:`date $DATEFMT`:$QRY >> /data/logs/export_fap.log

# generate progress page
#$echo $INFORMIXDIR/bin/fglgo /home/informix/shoe/code/EXPORT11C partners_na NA ES 1 "$QRY"
FILENM=export11C-`date $DATEFMT`.csv
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/EXPORT11C partners_na NA ES 1 "$QRY" > $EXPORTDIR/$FILENM
