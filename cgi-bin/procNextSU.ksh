...
#echo 2
#echo $HOME/NA/SU/P/${CEID}.html > /tmp/out.txt
# generate std page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA SU $CEID 1 > $HOME/NA/SU/P/${CEID}.html
## change permissions
chmod 666 $HOME/NA/SU/P/${CEID}.html

# generate secret page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA SU $CEID 2 > $HOME/NA/SU/P/${CEID}-sec.html
## change permissions
chmod 666 $HOME/NA/SU/P/${CEID}-sec.html

# generate update page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA SU $CEID 5 #> $HOME/NA/SU/P/${CEID}-upd.html
#cat $HOME/NA/SU/P/${CEID}-upd.html
