...
echo HW:$CEID:`date $DATEFMT`:$YNAME >> /data/logs/upd_history.log
...
#$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/UPDREC partners_na NA HW 0 "$var1"
# generate update page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA HW $CEID 5 #> $HOME/NA/HW/P/${CEID}-upd.html
#cat $HOME/NA/HW/P/${CEID}-upd.html
