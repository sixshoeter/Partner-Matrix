...
#echo 2
# generate std page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA BU $CEID 1 > $HOME/NA/BU/P/${CEID}.html
## change permissions
chmod 666 $HOME/NA/BU/P/${CEID}.html

# generate secret page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA BU $CEID 2 > $HOME/NA/BU/P/${CEID}-sec.html
## change permissions
chmod 666 $HOME/NA/BU/P/${CEID}-sec.html

# generate update page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA BU $CEID 5 #> $HOME/NA/BU/P/${CEID}-upd.html
#cat $HOME/NA/BU/P/${CEID}-upd.html
