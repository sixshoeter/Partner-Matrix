...
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA IO $CEID 2 > $HOME/NA/IO/P/${CEID}-sec.html
## change permissions
chmod 666 $HOME/NA/IO/P/${CEID}-sec.html

# generate std page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA IO $CEID 1 #> $HOME/NA/IO/P/${CEID}.html
## change permissions
chmod 666 $HOME/NA/IO/P/${CEID}.html
