...
#echo 2
# generate std page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA WU $CEID 1 > $HOME/NA/WU/P/${CEID}.html
## change permissions
chmod 666 $HOME/NA/WU/P/${CEID}-sec.html

# generate secret page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA WU $CEID 2 > $HOME/NA/WU/P/${CEID}-sec.html
## change permissions
chmod 666 $HOME/NA/WU/P/${CEID}-sec.html

# generate update page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA WU $CEID 5 #> $HOME/NA/WU/P/${CEID}-upd.html
#cat $HOME/NA/WU/P/${CEID}-upd.html
