...
#echo 2
# generate std page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA CU $CEID 1 > $HOME/NA/CU/P/${CEID}.html
## change permissions
chmod 666 $HOME/NA/CU/P/${CEID}.html

# generate secret page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA CU $CEID 2 > $HOME/NA/CU/P/${CEID}-sec.html
## change permissions
chmod 666 $HOME/NA/CU/P/${CEID}-sec.html

# generate update page
$INFORMIXDIR/bin/fglgo /home/informix/shoe/code/nBUILDPAGESU partners_na NA CU $CEID 5 #> $HOME/NA/CU/P/${CEID}-upd.html
#cat $HOME/NA/CU/P/${CEID}-upd.html
